...
const Ventas = () => {
    ...
    const obtenerVentas = async () => {
        const options = {
            method: 'GET',
            url: 'https://runteams-backend.herokuapp.com/ventas/',
            headers: {
...
const FilaVentas = ({ ventas, setEjecutarConsulta }) => {
    ...
    const actualizarVenta = async () => {
        ...
        const options = {
            method: 'PATCH',
            url: `https://runteams-backend.herokuapp.com/ventas/${ventas._id}/`,
            ...
            <td>
                ...
                <Dialog open={openDialog}>
                    <div className='p-8 flex flex-col'>
                        <h1 className='text-gray-800 text-2xl font-bold'>¿Desea eliminar la venta?</h1>
